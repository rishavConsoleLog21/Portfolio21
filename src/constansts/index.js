...
import chatit from "../assets/chatit.png";
...
const testimonials = [
  {
    ...
    company: "Acharya",
    image:
      "https://res.cloudinary.com/dffhtczwf/image/upload/v1694271419/Portfolio21/user.name/j2vk3tt7lz9bx6imt3mk.png",
  },
];
...
const projects = [
  ...
  },
  {
    ...
    description:
      "Countdown Game is a thrilling and engaging web app built using the React.js, offering users a fun and challenging experience. The game tests their reflexes and precision by challenging them to stop a countdown at precisely the right moment to win points. Key Features: Countdown Timer Selection, Start, Stop, Reset Buttons,Win or Lose and Score.",
    tags: [
      {
        name: "React JS",
        color: "blue-text-gradient",
  ...
  },
  {
    name: "ChatIt",
    description:
      "ChatIt is a real-time chat application that allows users to communicate with each other. Users can also send images and emojis in the chat room. The app uses Pusher for real-time communication, File and image upload using Cloudinary CDN. Credential authentication with NextAuth.",
    tags: [
      {
        name: "React JS",
        color: "blue-text-gradient",
  ...
  },
  {
    ...
    image: jobit,
    source_code_link:
      "https://github.com/rishavConsoleLog21/Smart-EV-Charging-Parking-Station.git",
  },
  {
